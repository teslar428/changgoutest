...
public class ReturnOrderController {
    ...
    public Result<PageInfo> findPage(@RequestBody(required = false) ReturnOrder returnOrder, @PathVariable("page") int page, @PathVariable("size") int size) {
    ...
    // 修改ReturnOrder数据
    @PutMapping("/{id}")
    public Result update(@RequestBody ReturnOrder returnOrder, @PathVariable("id") Long id) {
        //设置主键值
    ...
    // 根据ID查询ReturnOrder数据
    @GetMapping("/{id}")
    public Result<ReturnOrder> findById(@PathVariable("id") Long id) {
