...
public class ReturnCauseController {
    ...
    public Result<PageInfo> findPage(@RequestBody(required = false) ReturnCause returnCause, @PathVariable("page") int page, @PathVariable("size") int size) {
    ...
    // 修改ReturnCause数据
    @PutMapping("/{id}")
    public Result update(@RequestBody ReturnCause returnCause, @PathVariable("id") Integer id) {
        //设置主键值
