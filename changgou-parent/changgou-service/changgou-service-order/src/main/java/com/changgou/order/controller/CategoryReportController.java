...
public class CategoryReportController {
    ...
    public Result<PageInfo> findPage(@RequestBody(required = false) CategoryReport categoryReport, @PathVariable("page") int page, @PathVariable("size") int size) {
    ...
    public Result delete(@PathVariable("id") Date id) {
    ...
    // 修改CategoryReport数据
    @PutMapping("/{id}")
    public Result update(@RequestBody CategoryReport categoryReport, @PathVariable("id") Date id) {
        //设置主键值
